...
## 项目运行截图
###  初始主界面
![初始主界面](./assets/屏幕截图 2025-11-05 010245.png)

### 创建活动
公证人创建活动成功弹窗如下：
![创建活动成功](./assets/屏幕截图 2025-11-05 010936.png)
刷新可以在活动列表看到新建的活动，并且余额刷新：
![活动列表刷新](./assets/屏幕截图 2025-11-05 011400.png)

### 领取测试积分
用户页面如下：
![领取积分页面](./assets/屏幕截图 2025-11-05 012024.png)
非公证人点击领取后余额刷新：
![领取后更新](./assets/屏幕截图 2025-11-05 012131.png)

### 购买彩票
有了测试积分可以进行购票，如下输入相应信息完成购票：
![购票](./assets/屏幕截图 2025-11-05 012353.png)
可以在票券列表看到更新，同时余额更新：
![购票后更新](./assets/屏幕截图 2025-11-05 012532.png)

### 彩票挂单
挂单输入相应金额后成功界面如下：
![挂单](./assets/屏幕截图 2025-11-05 012353.png)

### 订单簿查询
可以输入活动ID查询该活动挂单彩票的订单簿，如下图：
![订单簿查询](./assets/屏幕截图 2025-11-05 013143.png)

### 下架挂单
点击订单簿下架后如下图下架成功，并且订单簿更新：
![下架](./assets/屏幕截图 2025-11-05 013321.png)

### 购买挂单彩票
如下图可以直接点击订单簿处的买入，也可以输入订单簿显示的彩票ID买入（买入成功弹窗忘记一起截进去了）：
![购买挂单](./assets/屏幕截图 2025-11-05 013615.png)
然后刷新可以在自己的票券列表中看到这个彩票，订单簿也会更新：
![购买挂单后更新](./assets/屏幕截图 2025-11-05 014019.png)

### 结算活动
如下图输入活动ID和获胜选项即可结算成功：
![结算活动](./assets/屏幕截图 2025-11-05 014303.png)

### 兑奖
结算后票券列表右侧会有兑奖按键，点击后兑奖成功界面如下：
![兑奖](./assets/屏幕截图 2025-11-05 014827.png)
